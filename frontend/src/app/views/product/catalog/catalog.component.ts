...
export class CatalogComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.cartService.getCart()
      .subscribe((data: CartType|DefaultResponseType) => {
        ...
        // Если заЛогинен, запрашиваем избранное, если произошла ошибка, все равно запрашиваем категории
            ...
            .subscribe(
              {
                next: (data: FavoriteType[] | DefaultResponseType) => {
                  ...
                  // Записываем избранные в переменную
  ...
  // Зарос на категории и отображение
  processCatalog() {
          ...
          .subscribe(params => {
            ...
            this.productService.getProducts(this.activeParams)
              .subscribe(data => {
                ...
                // Если продукт в избранном, перезаписываем массив
